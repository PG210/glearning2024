...
class GamesController extends Controller
{
    ...
    //consumir el api de retroalimentacion
    private function apiQuery($query){
          //consumo del servicio de API OPENAI
          $response = Http::post(env('API_BASE_URL') . 'ask/', [
            'query' => $query,
        ]);
        ...
        if ($response->successful()) {
            ...
            return 'Error al realizar feedback';
        }
    }
    ...
    //==================== playscorm ================
    public function playscorm(Request $request){
        $id = $request->idtipo;
        $idreto = $request->reto;
        ...
        if($validarcode){ //existe información
           ...
           //========================================================================================
            ...
            return back()->with('mensaje', 'Lo sentimos, el código ingresado es incorrecto, vuelve a intentarlo.');
        }
    }
