                  ...
                  <div class="col-md-12">
                    ...
                    <!--agregar link-->
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="video" id="video" placeholder="Agrega tu link de YouTube">
                      </div>
                    <!--end agregar link-->
                    <div class="form-group">
                        <label for="evidence">Descripcion Foto - Minimo 120 Caracteres</label>
                        <textarea class="form-control{{ $errors->has('evidence') ? ' is-invalid' : '' }}"  rows="5" name="evidence" id="evidence" spellcheck="true"  placeholder="A continuación escribe tus respuestas a las instrucciones planteadas en el Reto "required>
                       {{ old('evidence') }}
                     </textarea>
                    </div>
                  </div>
