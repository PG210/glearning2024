...
<head>
    ...
    <!-- <link rel="shortcut icon" href="{{ asset('juegos/rompecabezas/TemplateData/favicon.ico') }}"> -->
    <!-- <link rel="stylesheet" href="{{ asset('juegos/rompecabezas/TemplateData/style.css') }}"> -->
    <!-- <script src="{{ asset('juegos/rompecabezas/TemplateData/UnityProgress.js') }}"></script> -->
    <script src="{{ asset('juegos/rompecabezas/Build/UnityLoader.js') }}"></script>
    <script>
      var gameInstance = UnityLoader.instantiate("gameContainer", "{{ asset('juegos/rompecabezas/Build/rompecabezas.json') }} ");
    </script>
