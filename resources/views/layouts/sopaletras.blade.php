...
<head>
    ...
    <!-- Styles -->
    <!-- <link rel="shortcut icon" href="{{ asset('juegos/sopa/TemplateData/favicon.ico') }}">
    <link rel="stylesheet" href="{{ asset('juegos/sopa/TemplateData/style.css') }}">
    <script src="{{ asset('juegos/sopa/TemplateData/UnityProgress.js') }}"></script> -->
    <script src="{{ asset('juegos/sopa/Build/UnityLoader.js') }}"></script>
    <script>
      var gameInstance = UnityLoader.instantiate("unityContainer", "{{ asset('juegos/sopa/Build/sopa.json') }}");
    </script>
